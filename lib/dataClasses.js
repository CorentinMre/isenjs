...
class WebAurion {
  ...
  async init() {
    ...
    this.gradeData = new WebAurionGrades(this, this.session, this.payloadForGrades);
    Object.assign(this.payloadForAbsences, this.payload)
    this.absenceData = new WebAurionAbsences(this, this.session, this.payloadForAbsences);
    Object.assign(this.payloadForPlanning, this.payload)
    this.planningData = new WebAurionPlanning(this, this.session, this.payloadForPlanning);
  }
  ...
  userInfo() {
    ...
    let specEmail = `${firstName.join("-").toLowerCase()}.${firstLastName.toLowerCase()}@isen-ouest.yncrea.fr`;
...
class WebAurionAbsences extends WebAurion {
  ...
  async getAbsences() {
    ...
    const absencesPage = await this.__webAurion(absencesUrl, this.payload, this.ses);
