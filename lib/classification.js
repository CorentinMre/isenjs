...
class ClassMember {
    ...
    /**
     * Returns a dictionary representation of the ClassMember.
     * @returns {Object} A dictionary containing the member's attributes.
     */
    getDict(){
...
class ClassMemberReport {
    ...
    /**
     * Returns a dictionary representation of the ClassMemberReport.
     * @returns {Object} A dictionary containing the report's attributes.
     */
    getDict(){
...
class Grade {
    ...
    /**
     * Returns a dictionary representation of the Grade.
     * @returns {Object} A dictionary containing the grade's attributes.
     */
    getDict(){
...
class GradeReport {
    ...
    /**
     * Returns a dictionary representation of the GradeReport.
     * @returns {Object} A dictionary containing the report's attributes.
     */
    getDict(){
...
class Absence {
    ...
    /**
     * Returns a dictionary representation of the Absence.
     * @returns {Object} A dictionary containing the absence's attributes.
     */
    getDict(){
...
class AbsenceReport {
    ...
    /**
     * Returns a dictionary representation of the AbsenceReport.
     * @returns {Object} A dictionary containing the report's attributes.
     */
    getDict(){
