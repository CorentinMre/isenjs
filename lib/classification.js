...
class Event {
  ...
  toString() {
    ...
    return `Event(id='${this.id}', start='${this.startTime}', end='${this.endTime}', class_name='${this.className}', time='${this.details.time}', room='${this.details.room}', type='${this.details.type}', subject='${this.details.subject}', instructor='${this.details.instructors}' , group='${this.details.classGroups}')`;
  }
...
class PlanningReport {
  ...
  toJSON() {
    ...
    return {
      events: this.events.map((i) => i.toJSON()),
    };
  }
}
